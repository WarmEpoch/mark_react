...
var CanvasRenderer = /** @class */ (function (_super) {
    ...
    CanvasRenderer.prototype.resizeImage = function (container, image, width, height) {
        var _a;
        if (container instanceof image_element_container_1.ImageElementContainer && image.width === width && image.height === height) {
            return image;
        }
                                ...
                                switch (_h.label) {
                                    ...
                                    case 4:
                                        if (image) {
                                            ...
                                            pattern = this_1.ctx.createPattern(this_1.resizeImage(container, image, width, height), 'repeat');
